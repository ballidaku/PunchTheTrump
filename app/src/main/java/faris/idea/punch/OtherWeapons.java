...
import faris.idea.punch.MyUtilities.MyConstants;
import faris.idea.punch.MyUtilities.MySharedPreferences;
import faris.idea.punch.MyUtilities.MyUtil;
...
public class OtherWeapons extends AppCompatActivity implements View.OnClickListener
{
    ...
    private void check(String BWH)
    {
        ...
        if (BWH.equals(MyConstants.BASEBALL))
        {
            ...
            {
                Toast.makeText(context, "You don't have enough gold to buy item", Toast.LENGTH_SHORT).show();
            }
        }
